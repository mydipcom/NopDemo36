...
namespace Nop.Core.Html
{
    ...
    public partial class BBCodeHelper
    {
            ...
            bool replaceUnderline, bool replaceUrl, bool replaceCode, bool replaceQuote, bool replaceImg)
        {
            ...
            if (replaceUrl)
            {
                // format the url tags: [url=http://www.Campray.com]my site[/url]
                // becomes: <a href="http://www.Campray.com">my site</a>
                text = regexUrl1.Replace(text, "<a href=\"$1\" rel=\"nofollow\">$2</a>");

                // format the url tags: [url]http://www.Campray.com[/url]
                // becomes: <a href="http://www.Campray.com">http://www.Campray.com</a>
            ...
            if (replaceImg)
            {
                // format the img tags: [img]http://www.Campray.com/Content/Images/Image.jpg[/img]
                // becomes: <img src="http://www.Campray.com/Content/Images/Image.jpg"></img>
