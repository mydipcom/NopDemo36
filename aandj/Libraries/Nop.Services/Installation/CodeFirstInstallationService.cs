            ...
            settingService.SaveSetting(new StoreInformationSettings
                {
                    ...
                    FacebookLink = "http://www.facebook.com/Campray",
                    TwitterLink = "https://twitter.com/Campray",
                    YoutubeLink = "http://www.youtube.com/user/Campray",
            ...
            var news = new List<NewsItem>
                                {
                                    new NewsItem
                                    {
	                                     ...
	                                     Language = defaultLanguage,
	                                     Title = "About Campray",
	                                     Short = "It's stable and highly usable. From downloads to documentation, www.Campray.com offers a comprehensive base of information, resources, and support to the Campray community.",
	                                     Full = "<p>For full feature list go to <a href=\"http://www.Campray.com\">Campray.com</a></p><p>Providing outstanding custom search engine optimization, web development services and e-commerce development solutions to our clients at a fair price in a professional manner.</p>",
	                                     Published  = true,
	                                     CreatedOnUtc = DateTime.UtcNow,
                                    },
                                    new NewsItem
                                    {
	                                     AllowComments = true,
	                                     Language = defaultLanguage,
	                                     Title = "Campray new release!",
	                                     Short = "Campray includes everything you need to begin your e-commerce online store. We have thought of everything and it's all included! Campray is a fully customizable shopping cart",
	                                     Full = "<p>Campray includes everything you need to begin your e-commerce online store. We have thought of everything and it's all included!</p>",
	                                     Published  = true,
	                                     CreatedOnUtc = DateTime.UtcNow.AddSeconds(1),
                                    },
                                    new NewsItem
                                    {
	                                     ...
	                                     Short = "The new Campray store is open now! We are very excited to offer our new range of products. We will be constantly adding to our range so please register on our site.",
